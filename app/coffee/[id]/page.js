            ...
            <div className="row">
                ...
                <div className="border rounded-4 mb-3 d-flex justify-content-center flex-column">
                  ...
                  <div className="mt-2 ms-2 location align-items-center d-flex flex-row">
                    ...
                    <p className="mt-3 ms-lg-2 ">
                      {product.title} available in All our Coffee Store
                    </p>
                  </div>
                </div>
              </aside>
              <main className="col-lg-6">
                <div className="ps-lg-3">
                  <h4 className="title text-dark fw- ">{product.title}</h4>
                  ...
                  <div className="Description mt-4">
                    <p className="product-descTitle ">Description: </p>
                  ...
                  <div className="Size ">
                    ...
                    <div className="d-flex flex-row justify-content-around mt-3">
                      ...
                      >
                        <Image
                          className="Small-cup"
                          src={isSizeSelected("Tall") ? SelectedCup : cup}
                          alt="cup"
                      ...
                      >
                        <Image
                          ...
                          src={isSizeSelected("Grande") ? SelectedCup : cup}
                          alt="cup"
                      ...
                      >
                        <Image
                          className="Venti-cup"
                          src={isSizeSelected("Venti") ? SelectedCup : cup}
                          alt="cup"
                  ...
                  <div className="mt-5 d-flex justify-content-between order ">
                    <span className="Price-text ms-2">
                      {" "}
                      Price:{" "}
                      <span className="price ms-lg-3">${getRandomPrice()}</span>
                    </span>
